...
from payfactory_python_sdk.pydantic.multi_error_response_messages import MultiErrorResponseMessages

class MultiErrorResponse(BaseModel):
    status: typing.Optional[int] = Field(None, alias='status')

    messages: typing.Optional[MultiErrorResponseMessages] = Field(None, alias='messages')
    class Config:
