...
class BaseApi(api_client.Api):
    ...
    def _get_session_info_mapped_args(
        self,
        session_id: str,
    ...
    async def _aget_session_info_oapg(
        self,
...
class GetSessionInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_session_info(
        self,
        session_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_session_info_mapped_args(
            session_id=session_id,
        )
        return await self._aget_session_info_oapg(
    ...
    def get_session_info(
        ...
        return self._get_session_info_oapg(
            path_params=args.path,
        )

class GetSessionInfo(BaseApi):
    ...
    async def aget_session_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_session_info(
            session_id=session_id,
            **kwargs,
        )
        if validate:
    ...
    def get_session_info(
        ...
        raw_response = self.raw.get_session_info(
            session_id=session_id,
        )
        if validate:
            return SessionResponsePydantic(**raw_response.body)
