...
class BaseApi(api_client.Api):
    ...
    def _update_session_activity_mapped_args(
        self,
        session_id: str,
    ...
    async def _aupdate_session_activity_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/ApplicationForm/session/{sessionId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_session_activity_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateSessionActivityRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_session_activity(
        self,
        session_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._update_session_activity_mapped_args(
            session_id=session_id,
        )
        return await self._aupdate_session_activity_oapg(
    ...
    def update_session_activity(
        ...
        return self._update_session_activity_oapg(
            path_params=args.path,
        )

class UpdateSessionActivity(BaseApi):
    ...
    async def aupdate_session_activity(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_session_activity(
            session_id=session_id,
            **kwargs,
        )
        if validate:
    ...
    def update_session_activity(
        ...
        raw_response = self.raw.update_session_activity(
            session_id=session_id,
        )
        if validate:
            return SessionResponsePydantic(**raw_response.body)
