...
class BaseApi(api_client.Api):
    ...
    def _start_underwriting_process_mapped_args(
        self,
        app_id: str,
    ...
    async def _astart_underwriting_process_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/Application/StartUnderwriting/{appId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _start_underwriting_process_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class StartUnderwritingProcessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def astart_underwriting_process(
        self,
        app_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._start_underwriting_process_mapped_args(
            app_id=app_id,
        )
        return await self._astart_underwriting_process_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def start_underwriting_process(
        self,
        app_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._start_underwriting_process_oapg(
            path_params=args.path,
        )

class StartUnderwritingProcess(BaseApi):
    ...
    async def astart_underwriting_process(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.astart_underwriting_process(
            app_id=app_id,
            **kwargs,
        )
    ...
    def start_underwriting_process(
        ...
        raw_response = self.raw.start_underwriting_process(
            app_id=app_id,
        )
