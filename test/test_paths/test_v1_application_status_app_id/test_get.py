...
from payfactory_python_sdk.paths.v1_application_status_app_id import get
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ApplicationStatusAppId(ApiTestMixin, unittest.TestCase):
    """
    V1ApplicationStatusAppId unit test stubs
