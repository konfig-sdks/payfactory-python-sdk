...
from payfactory_python_sdk.paths.v1_transaction_metadata import post
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1TransactionMetadata(ApiTestMixin, unittest.TestCase):
    """
    V1TransactionMetadata unit test stubs
