...
from payfactory_python_sdk.paths.v1_reporting_deposits_reference_id import get
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ReportingDepositsReferenceId(ApiTestMixin, unittest.TestCase):
    """
    V1ReportingDepositsReferenceId unit test stubs
