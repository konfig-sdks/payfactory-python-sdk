...
from payfactory_python_sdk.paths.v1_application_start_underwriting_app_id import post
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ApplicationStartUnderwritingAppId(ApiTestMixin, unittest.TestCase):
    """
    V1ApplicationStartUnderwritingAppId unit test stubs
