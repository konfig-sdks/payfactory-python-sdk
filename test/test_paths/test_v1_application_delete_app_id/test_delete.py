...
from payfactory_python_sdk.paths.v1_application_delete_app_id import delete
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ApplicationDeleteAppId(ApiTestMixin, unittest.TestCase):
    """
    V1ApplicationDeleteAppId unit test stubs
    """
