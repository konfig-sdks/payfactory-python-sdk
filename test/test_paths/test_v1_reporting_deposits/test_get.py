...
from payfactory_python_sdk.paths.v1_reporting_deposits import get
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ReportingDeposits(ApiTestMixin, unittest.TestCase):
    """
    V1ReportingDeposits unit test stubs
