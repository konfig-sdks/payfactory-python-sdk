...
from payfactory_python_sdk.paths.v1_application_submit import post
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ApplicationSubmit(ApiTestMixin, unittest.TestCase):
    """
    V1ApplicationSubmit unit test stubs
