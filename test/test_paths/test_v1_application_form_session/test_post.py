...
from payfactory_python_sdk.paths.v1_application_form_session import post
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ApplicationFormSession(ApiTestMixin, unittest.TestCase):
    """
    V1ApplicationFormSession unit test stubs
