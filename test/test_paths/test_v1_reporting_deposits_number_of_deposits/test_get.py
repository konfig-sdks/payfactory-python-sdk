...
from payfactory_python_sdk.paths.v1_reporting_deposits_number_of_deposits import get
from payfactory_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1ReportingDepositsNumberOfDeposits(ApiTestMixin, unittest.TestCase):
    """
    V1ReportingDepositsNumberOfDeposits unit test stubs
